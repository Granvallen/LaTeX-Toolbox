%- 导言区开始 - by Granvallen
\documentclass[a4paper,10.5pt,oweside]{article} % 注意单页时是不分奇偶页的 
% twoside 双页 oweside 单页
    ...
    \usepackage{titlesec} % 设置标题显示格式 一级标题 二级标题
        ...
        \titleformat{\section}{\xiaosihao\bfseries}{\thesection}{1em}{}
        \titleformat{\subsection}{\wuhao\bfseries}{\thesubsection}{1em}{}
        \titleformat{\subsubsection}{\wuhao\bfseries}{\thesubsubsection}{1em}{}
        \titleformat{\paragraph}{\wuhao\bfseries}{\theparagraph}{1em}{}
    ...
    \renewcommand{\refname}{\bfseries\xiaosihao{参考文献}} % article使用这个
    %\renewcommand{\bibname}{参考文献} % book使用这个
    \renewcommand{\bibfont}{\xiaowuhao} % 参考文献项的字体
    ...
    \newcommand{\AuthorID}[2]{\vspace{3ex} {\xiaosihao \bfseries #2, #1}}
    \newcommand{\Date}[1]{\vspace{2ex} {\wuhao \bfseries #1} \vspace{2ex}}
...
\begin{document}
    ...
    % - 前置 -
    \includepdf[pages=1]{./封面与尾页/封面.pdf} % pdf格式的封面 可以用pages指定页数
    ...
    \begin{center}
        ...
        % 中文摘要
        \Abstractcn{这是文献报告写作要求。排版格式要求包括用纸，页面设置、字体、行距等。基本要求中强调独立撰写，不可简单剪贴现成资料。对文献的数量和质量作出规定，提供文献清单实例，指出一些通病，并给出评分依据。注意中英文摘要一致。}{}
    ...
    \titleformat{\section}{}{\thesection}{1em}{} % 让 参考文献 几个字居中 好像没有更好的实现方法了
